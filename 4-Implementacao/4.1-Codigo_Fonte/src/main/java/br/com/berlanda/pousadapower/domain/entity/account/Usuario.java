package br.com.berlanda.pousadapower.domain.entity.account;
...
public class Usuario extends AbstractEntity implements Serializable, UserDetails
{
	 ...
	 * @param enabled
	 */
	public Usuario( Long id, String name, String email, Boolean enabled )
	{
		super( id );
		this.email = email;
		this.name = name;
	 ...
	 * @param role
	 */
	public Usuario( Long id, String name, String email, Boolean enabled, PermissaoUsuario role )
	{
		super( id );
		this.email = email;
		this.name = name;
	 ...
	 * @param password
	 */
	public Usuario( Long id, String name, String email, Boolean enabled, PermissaoUsuario role, String password )
	{
		super( id );
		this.email = email;
		this.name = name;
	 ...
	 *            the role to set
	 */
	public void setRole( PermissaoUsuario permissaoUsuario )
	{
		this.role = permissaoUsuario;
	}
